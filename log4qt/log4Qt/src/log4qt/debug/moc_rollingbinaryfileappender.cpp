...
void Log4Qt::RollingBinaryFileAppender::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<RollingBinaryFileAppender *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Log4Qt::RollingBinaryFileAppender::staticMetaObject = { {
    &BinaryFileAppender::staticMetaObject,
    qt_meta_stringdata_Log4Qt__RollingBinaryFileAppender.data,
    qt_meta_data_Log4Qt__RollingBinaryFileAppender,
    qt_static_metacall,
    nullptr,
    nullptr
} };
