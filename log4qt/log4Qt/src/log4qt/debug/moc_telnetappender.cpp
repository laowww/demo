...
void Log4Qt::TelnetAppender::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TelnetAppender *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Log4Qt::TelnetAppender::staticMetaObject = { {
    &AppenderSkeleton::staticMetaObject,
    qt_meta_stringdata_Log4Qt__TelnetAppender.data,
    qt_meta_data_Log4Qt__TelnetAppender,
    qt_static_metacall,
    nullptr,
    nullptr
} };
