...
QT_INIT_METAOBJECT const QMetaObject Log4Qt::ColorConsoleAppender::staticMetaObject = { {
    &ConsoleAppender::staticMetaObject,
    qt_meta_stringdata_Log4Qt__ColorConsoleAppender.data,
    qt_meta_data_Log4Qt__ColorConsoleAppender,
    qt_static_metacall,
    nullptr,
    nullptr
} };
