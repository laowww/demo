...
void Log4Qt::BinaryFileAppender::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::ReadProperty) {
        auto *_t = static_cast<BinaryFileAppender *>(_o);
        Q_UNUSED(_t)
        void *_v = _a[0];
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Log4Qt::BinaryFileAppender::staticMetaObject = { {
    &BinaryWriterAppender::staticMetaObject,
    qt_meta_stringdata_Log4Qt__BinaryFileAppender.data,
    qt_meta_data_Log4Qt__BinaryFileAppender,
    qt_static_metacall,
    nullptr,
    nullptr
} };
