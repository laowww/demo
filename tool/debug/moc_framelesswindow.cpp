...
static const char qt_meta_stringdata_FrameLessWindow[] = {
    "FrameLessWindow\0"
};
...
const QMetaObjectExtraData FrameLessWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject FrameLessWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FrameLessWindow,
      qt_meta_data_FrameLessWindow, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &FrameLessWindow::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FrameLessWindow))
        return static_cast<void*>(const_cast< FrameLessWindow*>(this));
