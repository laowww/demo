...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        comboBox->addItem(icon, QString());
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/images/icons/aim.ico"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        comboBox->setItemText(2, QApplication::translate("Widget", "\346\226\260\345\273\272\351\241\271\347\233\256", Q_NULLPTR));
